...
export const T = {
  en: {
    ...
    katbEyebrow: "Until Katb Kitab",
    katbDate: "Friday · August 7 · 2026",
    katbToday: "Katb Kitab Day",
    days: "Days",
    hours: "Hours",
    mins: "Minutes",
    secs: "Seconds",
  ...
  ar: {
    ...
    katbEyebrow: "حتى كتب الكتاب",
    katbDate: "الجمعة · ٧ أغسطس · ٢٠٢٦",
    katbToday: "يوم كتب الكتاب",
    days: "أيام",
    hours: "ساعات",
    mins: "دقائق",
    secs: "ثواني",
